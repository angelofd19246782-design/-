...
/* ============================================================================
   PRODUCT IMAGES — DEMO STATE
   ============================================================================
   This is a demo catalog. Two image strategies are mixed:

   1. Real licensed packaging photos (Wikimedia Commons + Open Food Facts,
      both CC-licensed) — used for products where an exact-or-close brand
      shot exists, e.g. Borjomi, Alenka, Krakovskaya, Doktorskaya, Сгущёнка
      Верховского, Doshirak, Maille pickles, etc.

   2. Clean SVG placeholders rendered client-side with the product name
      and a "DEMO IMAGE" watermark — used for products where no good
      licensed studio photo exists. Marked with image_url: 'placeholder'.
      The placeholder is generated by placeholderSVG() in public/js/catalog.js.

   ⚠️  BEFORE GOING TO PRODUCTION:
       Replace placeholders (and ideally all images) with real photos from
       the client's own suppliers / brand media-kits. The bundled fetcher
       (npm run fetch-images, scripts/images.manifest.json) makes this a
       1-step swap once URLs are in hand. See the README "Hosting your own
...
const products = [
  ...
  // Kefir / Ryazhenka are dairy bottles — using the Borjomi water bottle
  // would mislead. Placeholder until a real dairy photo is supplied.
  { name: 'Kefir 2.5%', category: 'dairy', price: 4800, accent: '#5a9ec7',
    image_url: 'placeholder',
    description: 'Fermented milk drink, lightly tart and refreshing. 1L bottle.' },
  { name: 'Ryazhenka 4%', category: 'dairy', price: 5200, accent: '#d6a06a',
    image_url: 'placeholder',
  ...
  // Kvass is a brown rye drink — cranberry-juice photo would mislead.
  ...
  { name: 'Zefir vanilla', category: 'sweets', price: 6700, accent: '#e8a4b8',
    image_url: 'placeholder',
  ...
  // ===== Ready food — placeholders for items without good packaged photos =====
